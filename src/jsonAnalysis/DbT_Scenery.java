...
//		String fullUrl = extObj.getString("");
		...
		String sql = "insert into t_scenery_copy (sid, surl, sname, ambiguity_sname, parent_sid, "
		...
		String sql2="insert into t_scenery_des_copy (sid, surl, sname, ambiguity_sname,abs_desc, more_desc) values (?,?,?,?,?,?)";
		String[] params = {
				sid,
				surl,
				sname,
...
//		System.out.println();
	...
	public static void main(String[] args){
		DbT_Scenery parser = new DbT_Scenery();
...
//		parser.parseSceneList(new File("E:\\traveldata\\webAll\\daixianyangjiacitang-1.json"));
		parser.runTask(new File("D:\\Study\\scenerydata\\weballscenery1"));
//		parser.reparse();
	}
}
